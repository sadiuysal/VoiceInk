...
class SelectedTextService {
    ...
    private static let privatePasteboardType = NSPasteboard.PasteboardType("com.sadiuysal.VoiceInk.transient")

    static func fetchSelectedText() -> String? {
        // Don't check for selected text within VoiceInk itself
        guard let frontmostApp = NSWorkspace.shared.frontmostApplication,
              frontmostApp.bundleIdentifier != "com.sadiuysal.VoiceInk" else {
            return nil
        }
